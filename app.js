...
if (APP_ENV === 'test') {
  // streamRecording(6000, false).catch(e => console.error('Main error for stream recording', e));
  ...
  cron.schedule('0 * * * *', () => {
    ...
    streamRecording(timelength).catch(e => console.error('Main error for stream recording', e));
  });
